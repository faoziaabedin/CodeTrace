    ...
    return `
        <div class="session-card ${isActive ? 'active' : ''}" onclick="loadSession('${session.sessionId}')">
            ...
            <div class="session-header">
                <div>
                    <div class="session-title">${hasSummary ? session.summary.suggestedTitle : formattedDate}</div>
                    <div class="session-id">${formattedDate} • Started ${formattedTime}</div>
                </div>
                <span class="session-status ${isActive ? 'active' : 'completed'}">
                    ${isActive ? '● Recording' : hasSummary ? '✨ Summarized' : 'Completed'}
                </span>
            </div>
            ...
            ${hasSummary ? `
                <div class="ai-summary-preview">
                    ...
                    <span class="summary-text">${session.summary.whatWasBuilt}</span>
                </div>
            ` : ''}
    ...
    detailView.innerHTML = `
        ...
        <div class="ai-summary-card">
            <div class="ai-summary-header">
                <span class="ai-badge-large">🤖 AI Summary</span>
                <span class="ai-model">Generated by ${session.summary.model}</span>
            </div>
            <h2 class="ai-summary-title">${session.summary.suggestedTitle}</h2>
            <div class="ai-summary-content">
                <div class="ai-summary-section">
                    <div class="ai-summary-label">What Was Built</div>
                    <div class="ai-summary-text">${session.summary.whatWasBuilt}</div>
                </div>
                <div class="ai-summary-section">
                    <div class="ai-summary-label">Apparent Goal</div>
                    <div class="ai-summary-text">${session.summary.apparentGoal}</div>
                </div>
                <div class="ai-summary-section">
                    <div class="ai-summary-label">Key Files</div>
                    <div class="ai-summary-files">
                        ${session.summary.keyFilesModified.map(f => `<span class="file-tag">${f}</span>`).join('')}
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="ai-summary-placeholder">
            ...
            <button class="btn btn-primary btn-sm" onclick="requestSummary('${session.sessionId}')">
                Generate Summary
            </button>
        </div>
        `}
        ...
        <div class="session-detail-header">
            <div class="session-detail-title">${hasSummary ? session.summary.suggestedTitle : formatDate(startDate)}</div>
...
/**
 * Request AI summary generation for a session
 */
function requestSummary(sessionId) {
    vscode.postMessage({ 
